...
int llcc_configure_staling_mode(struct llcc_slice_desc *desc,
		struct llcc_staling_mode_params *params);

void llcc_notif_staling_inc_counter(struct llcc_slice_desc *desc);
...
static inline void llcc_notif_staling_inc_counter(struct llcc_slice_desc *desc)
{
}
#endif
