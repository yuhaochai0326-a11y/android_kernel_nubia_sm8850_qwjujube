...
static inline int qcom_scm_mem_protect_sd_ctrl(u32 device_id, u32 mem_addr,
				 u32 mem_size, u32 cp_start)
{
	return -EOPNOTSUPP;
}
...
static inline int qcom_scm_gpu_init_regs(u32 gpu_req)
{
	return 0;
}
