...
struct dsi_panel {
	...
	u32 dim_delay;
	bool pending_rebl;
	struct work_struct rebl_work;
	struct workqueue_struct *rebl_workq;
	bool pending_aodbl;
	struct work_struct aodbl_work;
	struct workqueue_struct *aodbl_workq;
	u32 vsync_width;
	u32 bl_normalmax_level;
	u32 aod_state;
	bool aod_layer;
	bool fod_layer;
	bool has_bl;
	bool skip_nolp;
	struct work_struct nolp_work;
	struct workqueue_struct *nolp_workq;
    #endif
};
