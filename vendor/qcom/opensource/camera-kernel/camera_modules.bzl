...
def _define_module(target, variant):
    ...
    ddk_module(
        ...
        conditional_srcs = {
            ...
            "CONFIG_SPECTRA_SENSOR": {
                True: [
                    ...
                    "drivers/cam_sensor_module/zte_io/ois_dw9785.c",
        ...
        local_defines = get_zte_tof_feature(),
    )
