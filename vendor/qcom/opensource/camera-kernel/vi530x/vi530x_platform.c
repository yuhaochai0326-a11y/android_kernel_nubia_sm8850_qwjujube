...
static int32_t vi530x_i2c_write(VI530X_DEV dev, uint8_t reg, uint8_t *data, uint8_t len)
{
	int ret = 0;
	uint8_t *addr_buf;
	struct i2c_msg msg;
...
static int32_t vi530x_i2c_read(VI530X_DEV dev, uint8_t reg, uint8_t *data, uint8_t len)
{
	int ret =0;
